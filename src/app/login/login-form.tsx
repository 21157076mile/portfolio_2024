        ...
        <div>
          ...
          <div className="mt-2">
            <input
              ...
              name="email"
              type="email"
              className="block w-full rounded-md border-0 p-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-inset focus:ring-gray-700 sm:text-sm sm:leading-6 dark:text-slate-300"
            />
            {errors.email ? (
        ...
        <div>
          ...
          <div className="mt-2">
            <PasswordInput
              ...
              id="password"
              name="password"
              className="block w-full rounded-md border-0 p-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-inset focus:ring-gray-700 sm:text-sm sm:leading-6 dark:text-stone-300"
            />
            {errors.password ? (
              <div className="mt-1 block text-sm text-red-500">
